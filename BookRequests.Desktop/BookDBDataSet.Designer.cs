...
namespace BookRequests.Desktop {
    ...
    public partial class BookDBDataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BooksRow AddBooksRow(string BookName, int NumberOfPage, string Language) {
...
namespace BookRequests.Desktop.BookDBDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Books] WHERE (([Id] = @Original_Id) AND ([NumberOfPage] = @Ori" +
                "ginal_NumberOfPage))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([BookName], [NumberOfPage], [Language]) VALUES (@BookN" +
                "ame, @NumberOfPage, @Language);\r\nSELECT Id, BookName, NumberOfPage, Language FRO" +
                "M Books WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Books] SET [BookName] = @BookName, [NumberOfPage] = @NumberOfPage, " +
                "[Language] = @Language WHERE (([Id] = @Original_Id) AND ([NumberOfPage] = @Origi" +
                "nal_NumberOfPage));\r\nSELECT Id, BookName, NumberOfPage, Language FROM Books WHER" +
                "E (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, BookName, NumberOfPage, Language FROM dbo.Books";
        ...
        public virtual int Delete(int Original_Id, int Original_NumberOfPage) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_NumberOfPage));
        ...
        public virtual int Insert(string BookName, int NumberOfPage, string Language) {
            if ((BookName == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(NumberOfPage));
            if ((Language == null)) {
        ...
        public virtual int Update(string BookName, int NumberOfPage, string Language, int Original_Id, int Original_NumberOfPage, int Id) {
            if ((BookName == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(NumberOfPage));
            if ((Language == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_NumberOfPage));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string BookName, int NumberOfPage, string Language, int Original_Id, int Original_NumberOfPage) {
            return this.Update(BookName, NumberOfPage, Language, Original_Id, Original_NumberOfPage, Original_Id);
        }
    }
